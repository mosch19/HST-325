...
/* stage zoomer â€” lets you zoom in/out by clicking on things -- should not need to touch! */
...
function zoom_it(d) {
	...
	if(!d&& !centered) {
		...
		zoom_factor = 1;
		centered = null;
	} else if(d.positions && centered !==d) { //if you click on something that has a "positions" property, it will center on it â€” this makes circles clickable
		x = d.positions[0];
		y = d.positions[1];
